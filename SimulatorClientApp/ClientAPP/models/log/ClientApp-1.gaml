...
species client skills: [SQLSKILL] {
	...
	float va_titude <- rnd(1000)/100000 update: rnd(10000)/100000;
	float longitude <- 59.8581 + va_titude;
	float latitude <- 17.6447 + va_titude;
	...
	*/
	...
	reflex update_att when: weekDay = 1 { 
		...
		if user_name = regular_user2[0,mx_index] {
			...
			save ["userId=" + user_name + "&" + up_to_date_stTime + "&" + up_to_date_edTime + "&" + request_time  + 
			"&stPosition=" + regular_user2[3,mx_index] + "&edPosition=" + regular_user2[4,mx_index] + "&priority=" + priority + 
			"&startPositionLatitude=" + string(latitude) + "&startPositionLongitude=" + string(longitude)] 
			...
			if (hot_st_lgt != 0 and hot_ed_lgt !=0){
				...
				save ["userId=" + user_name + "&" + start_time + "&" + end_time + "&" + request_time  + "&stPosition=" + start_position + "&edPosition=" + 
					  end_position + "&priority=" + priority + "&startPositionLatitude=" + string(latitude) + "&startPositionLongitude=" + string(longitude)
				] 
		    			to: "ClientRequest" type:csv;}
	...
	reflex update_att1 when: weekDay = 2{ 
			...
			if user_name = regular_user2[0,mx_index] {	
				...
				save ["userId=" + user_name + "&" + up_to_date_stTime + "&" + up_to_date_edTime + "&" + request_time  + "&stPosition=" + regular_user2[3,mx_index] + "
						&edPosition=" + regular_user2[4,mx_index] + "&priority=" + priority + 
						"&startPositionLatitude=" + string(latitude) + "&startPositionLongitude=" + string(longitude)] 
		    			to: "ClientRequest" type:csv;
				...
				if (hot_st_lgt != 0 and hot_ed_lgt !=0){ 
    	           ...
    	           //	write bus_stop_list;
					...
					save ["userId=" + user_name + "&" + start_time + "&" + end_time + "&" + request_time  + "&stPosition=" + start_position + "&edPosition=" + 
						end_position + "&priority=" + priority + 
						"&startPositionLatitude=" + string(latitude) + "&startPositionLongitude=" + string(longitude)
					] 
		    				to: "ClientRequest" type:csv;}

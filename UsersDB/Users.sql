...
pass (password) field depends on the hashing algorithm. e.g. here is SHA-1
 ...
 same with the activated field where the default is '0' (not activated) and
 as soon  as the user activates his/her account it is updated to '1'
*/

DELIMITER $$

CREATE FUNCTION `SIGNUP` (uname VARCHAR(255),fname VARCHAR(255),
						  lname VARCHAR(255), em VARCHAR(255),
						  ph VARCHAR(15), pass VARCHAR(255))
RETURNS SMALLINT
BEGIN
	...
	ELSE
		...
		VALUES (uname, fname, lname, em, ph, sha1(pass));
		RETURN 3;
	END IF;
END $$
...
/*
INSERT INTO USER_PROFILE(username, firstname, lastname, email, phone, pass)
VALUES('chge','Charalampos', 'Georgiadis', 'babispasg@gmail.com', '1234567890',
			 'mypass');

INSERT INTO USER_PROFILE(username, firstname, lastname, email, phone, pass)
VALUES('chko', 'Charalampos', 'Kominos', 'charis@gmail.com', '0987654321',
			 '1234');
...
SELECT SIGNUP('cGge','Charalampos', 'Georgiadis', 'babispas@gmail.com',
							'1234567891', 'mypassword');

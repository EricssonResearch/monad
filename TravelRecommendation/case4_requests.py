...
for i in range(28):
    ...
    new_record3 = {"username": "user",
                  "start_time": datetime.datetime(2015, 11, day, random.choice(seq), random.randint(0,59), random.randint(0,59)),
                  "end_time": datetime.datetime(2015, 11, day, random.choice(seq), random.randint(0,59), random.randint(0,59)),"start_position_lat": coordinates[first][0],
                  "start_position_lon": coordinates[first][1],
                  "end_position_lat": coordinates[second][0],
                  "end_position_lon": coordinates[second][1],
                  "request_time": datetime.datetime(2015, 11, day, random.choice(seq), random.randint(0,59), random.randint(0,59)),
                  }

    new_record4 = {"username": "user",
                  "start_time": datetime.datetime(2015, 11, day, 12, random.randint(0,12), random.randint(0,59)),
                  "end_time": datetime.datetime(2015, 11, day, 12, random.randint(0,12), random.randint(0,59)),"start_position_lat": coordinates[3][0],
                  "start_position_lon": coordinates[3][1],
                  "end_position_lat": coordinates[4][0],
                  "end_position_lon": coordinates[4][1],
                  "request_time": datetime.datetime(2015, 11, day, random.choice(seq), random.randint(0,59), random.randint(0,59)),
                  }
    TravelRequest.insert_many([new_record1, new_record2, new_record3, new_record4])
    day += 1

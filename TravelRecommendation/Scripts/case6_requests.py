...
for i in range(1000):
    ...
    new_record1 = {"username": "user",
                  "start_time": datetime.datetime(2015, 11, random.randint(1,28), 8, random.randint(25,50), random.randint(0,59)),
                  "end_time": datetime.datetime(2015, 11, random.randint(1,28), 9, random.randint(0,10), random.randint(0,59)),
                  ...
                  "request_time": datetime.datetime(2015, 11, random.randint(1,28), 8, random.randint(0,18), random.randint(0,59))
                  }
    new_record2 = {"username": "user",
                  "start_time": datetime.datetime(2015, 11, random.randint(1,28), 17, random.randint(5,20), random.randint(0,59)),
                  "end_time": datetime.datetime(2015, 11, random.randint(1,28), 17, random.randint(40,59), random.randint(0,59)),
                  ...
                  "request_time": datetime.datetime(2015, 11, random.randint(1,28), 17, random.randint(0,5), random.randint(0,59))
                  }

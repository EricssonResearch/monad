...
for i in range(28):
    ...
    new_record3 = {"username": "user",
                  ...
                  "end_time": datetime.datetime(2015, 11, day, random.choice(seq), random.randint(0,59), random.randint(0,59)),
                  "start_position_lat": coordinates[first][0],
    ...
    new_record5 = {"username": "user",
                  "start_time": datetime.datetime(2015, 11, day, 12, random.randint(0,12), random.randint(0,59)),
                  "end_time": datetime.datetime(2015, 11, day, 13, random.randint(0,12), random.randint(0,59)),
                  "start_position_lat": coordinates[3][0],
                  "start_position_lon": coordinates[3][1],
                  "end_position_lat": coordinates[1][0],
                  "end_position_lon": coordinates[1][1],
                  "request_time": datetime.datetime(2015, 11, day, random.choice(seq), random.randint(0,59), random.randint(0,59)),
                  }
    TravelRequest.insert_many([new_record1, new_record2, new_record3, new_record5])
    day += 1

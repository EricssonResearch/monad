...
# Creating a minimizing fitness class to minimize a single objective that inherits from the base class "Fitness".
creator.create("FitnessMin", base.Fitness, weights=(-1.0,))
# Creating an individual class that inherits a list property and has a fitness attribute of type FitnessMin
